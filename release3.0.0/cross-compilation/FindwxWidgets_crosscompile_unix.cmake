...
MESSAGE(" wxWidgets_FIND_STYLE=${wxWidgets_FIND_STYLE} ")
MESSAGE("changing to unix style ...")
SET( wxWidgets_FIND_STYLE "unix")
MESSAGE(" wxWidgets_FIND_STYLE=${wxWidgets_FIND_STYLE} ")
...
IF(wxWidgets_FIND_STYLE STREQUAL "win32")
  ...
  MESSAGE( " pos 3")
  MESSAGE("Common libraries: ${wxWidgets_COMMON_LIBRARIES}")
  ...
  MACRO(WX_FIND_LIBS _UNV _UCD _DBG)
    ...
    FOREACH(LIB ${wxWidgets_COMMON_LIBRARIES})
      MESSAGE(" calling FIND_LIBRARY(WX_${LIB}${_DBG} NAMES wx${LIB}${_UCD}${_DBG} wx${LIB}${_DBG}")
    ...
    MESSAGE(" calling FIND_LIBRARY(WX_base${_DBG} ...)")
  ...
  MESSAGE("looking for an installation tree: wxWidgets_ROOT_DIR with include/wx/wx.h")
  ...
  MESSAGE(" now WX_ROOT_DIR = ${WX_ROOT_DIR}")
