...
%
\providecommand{\vep}[1]{  \vec{ \bf v}_{#1} }%
\providecommand{\Vect}[1]{  \vec{\bf #1 } }  % for vectors ...%
\providecommand{\Norm}[1]{\parallel #1 \parallel} 
...
$C_{{\bf x},  \vec{ \bf v}_{1} ,  \vec{ \bf v}_{2} ,\tau \sigma}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}
    ...
    \sum_{i=0}^{N-1} - \sigma \nabla_{\sigma} I \left( {\bf x}+ \tau \sigma\:
      \vec{\bf v } _\alpha \right) .   \vec{\bf v } _\alpha,
\end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
...
$  \vec{\bf v } _\alpha = cos(\alpha)   \vec{ \bf v}_{1}  + sin(\alpha)   \vec{ \bf v}_{2} $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
