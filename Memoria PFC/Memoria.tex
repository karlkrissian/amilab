...
\section{Slicer}
Slicer es un software de código abierto y libre que se utiliza para la visualización y análisis de imágenes. Se diseño pensando en que fuese multiplataforma.\cite{slicer}
...
\begin{figure}
\centering
\includegraphics[scale=0.7]{imagetoimagefilter.PNG}%ext=pdf,jpg,png
...
\begin{figure}
\centering
\includegraphics[scale=0.7]{basicnlmeansfilter.PNG}%ext=pdf,jpg,png
