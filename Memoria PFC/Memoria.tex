...
\begin{itemize}
	...
	\item Portátil Centrino Duo con 1GB de RAM
\end{itemize}
\end{itemize}
...
\subsubsection{Punteros elegantes y manejo de memoria}
...
\subsubsection{Procesamiento de datos en el pipeline}
...
\subsubsection{Clases principales a utilizar}
...
\subsubsection{Clase Image Iterator}
...
\subsubsection{Clase Neighborhood Iterators}
...
\item Al inicializar una variable de tipo string o filename basta con asignarle el valor que queramos que tenga.
\end{itemize}
...
\section{Actividad 2 Análisis}
\subsection{¿Cómo implementar un filtro?}
...
\subsection{Filtro NLMeans Básico}
...
\subsection{Segmentación de la carótida}
\subsubsection{Clase BackTracking}

\section{Actividad 3 Análisis}

\chapter{Diseño}
\section{Actividad 1 Diseño}
\subsection{Multihilos}
...
\subsection{Filtro Non Local Means Básico}
