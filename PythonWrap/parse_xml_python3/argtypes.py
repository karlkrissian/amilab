...
class ArgTypeBase:
    ...
    def SetName(self, n, is_empty:bool = False):
        self._name = n
        self._empty_name = is_empty
...
class TypedefInfo(ArgTypeBase):
    ...
    def GetString(self):
        ...
        try:
            ...
            elif maintype.GetType() == "Struct" and maintype.EmptyName():
                typename = self.GetName()
            else:
    ...
    def GetFullString(self):
        try:
            ...
            print(f"Exception {e}, using _reftypeid as typename")
            typename = self._reftypeid
        return typename
...
class EnumerationInfo(ArgTypeBase):
    ...
    def SetName(self, n):
        ...
        if self._context in config.types and config.types[self._context].GetString() != "::":
            ...
            logging.warning(f"Enum not registered because of missing context {self.GetName()} {self._context=}")
