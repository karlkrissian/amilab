...
classes_includes = {
  ...
  "std::_Tree_simple_types<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >" : "set",
  "std::_Rb_tree_const_iterator<std::basic_string<char> >" : "set",
  ...
  "std::set" : "set",
  "std::set<std::basic_string<char> >" : "set",
