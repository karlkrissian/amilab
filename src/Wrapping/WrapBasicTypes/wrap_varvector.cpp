...
AMIObject* AddWrapVarVector( const VarVector::ptr& objectptr)
{
  ...
  ADDMEMBER("push_front",       VarVector, push_front);
  ADDMEMBER("push_back",        VarVector, push_back);

  ADDMEMBER("pop_front",       VarVector, pop_front);
...
Variable::ptr wrap_VarVector( ParamList* p)
{
  ...
  AMIObject* amiobject = AddWrapVarVector(pp);
  Variable::ptr varres(new Variable());
  varres->Init(type_ami_object,"tmp_varvector", (void*) amiobject);
...
//  push_front
//---------------------------------------------------
void wrap_VarVectorpush_front::SetParametersComments() 
{
  ADDPARAMCOMMENT("variable: input variable to add.");
}
//---------------------------------------------------
Variable::ptr wrap_VarVectorpush_front::CallMember( ParamList* p)
{
  ...
  this->_objectptr->vector.push_front(var);
...
//---------------------------------------------------
Variable::ptr wrap_VarVectorpush_back::CallMember( ParamList* p)
{
...
//  pop_front
//---------------------------------------------------
void wrap_VarVectorpop_front::SetParametersComments() {}
//---------------------------------------------------
Variable::ptr wrap_VarVectorpop_front::CallMember( ParamList* p)
{
  this->_objectptr->vector.pop_front();
  return Variable::ptr();
}
...
//---------------------------------------------------
Variable::ptr wrap_VarVectorpop_back::CallMember( ParamList* p)
{
...
//---------------------------------------------------
Variable::ptr wrap_VarVectorsize::CallMember( ParamList* p)
{
...
//---------------------------------------------------
Variable::ptr wrap_VarVectorfront::CallMember( ParamList* p)
{
...
//---------------------------------------------------
Variable::ptr wrap_VarVectorback::CallMember( ParamList* p)
{
  if (this->_objectptr->vector.empty()) 
    return Variable::ptr();
  else
...
//---------------------------------------------------
Variable::ptr wrap_VarVectorat::CallMember( ParamList* p)
{
