...
class WrapClass_RGBTransformComponent: public WrapClass<RGBTransformComponent>, public WrapClass_RGBTransformBase
{
  ...
  public:
    ...
    /// Constructor
    WrapClass_RGBTransformComponent(RGBTransformComponent::ptr si): WrapClass<RGBTransformComponent>(si),WrapClass_RGBTransformBase(si) { }
