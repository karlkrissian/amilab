...
bool MCamera::getImages3( unsigned char ***li, unsigned char ***ri, unsigned char ***mi)
{
	...
	r = Camera_ImagesGet3(m_handle, (unsigned char *)limage, (unsigned char *)rimage, (unsigned char *)mimage);
	if (r != mtOK) {
		*li = NULL;
		*ri = NULL;
		*mi = NULL;
...
bool MCamera::getHalfSizeImages3(unsigned char ***li, unsigned char ***ri, unsigned char ***mi, int xRes, int yRes)
{
	...
	r = Camera_HalfSizeImagesGet3(m_handle, (unsigned char *)limage, (unsigned char *)rimage, (unsigned char *)mimage);
	if (r != mtOK)
	{
		*li = NULL;
		*ri = NULL;
