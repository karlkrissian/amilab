...
/*
  ...
  */
void WrapClass_wxInitDialogEvent::AddStaticMethods( Variables::ptr& context)
{
  // Create a new context (or namespace) for the class
  AMIObject::ptr amiobject(new AMIObject);
  amiobject->SetName("wxInitDialogEvent");
    WrapClass_wxInitDialogEvent::AddVar_wxInitDialogEvent_1(amiobject->GetContext());
  WrapClass_wxInitDialogEvent::AddVar_wxInitDialogEvent(amiobject->GetContext());
  WrapClass_wxInitDialogEvent::AddVar_wxInitDialogEvent_2(amiobject->GetContext());
