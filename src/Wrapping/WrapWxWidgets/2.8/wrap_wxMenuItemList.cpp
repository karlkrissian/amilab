    ...
    wrap_wxMenuItemList_3::CallMember( ParamList* _p)
{
  ...
  wxMenuItem* local_elements = NULL;
  wxMenuItem** elements;
  if (CheckNullVar(_p,_n))  {
    elements=(wxMenuItem**)NULL;
    _n++;
  } else {
    ...
    wrap_Insert_3::CallMember( ParamList* _p)
{
  ...
  wxwxMenuItemListNode* prev;
  if (CheckNullVar(_p,_n))  {
    prev=(wxwxMenuItemListNode*)NULL;
    _n++;
  } else {
    ...
    wrap_DetachNode::CallMember( ParamList* _p)
{
  ...
  if (CheckNullVar(_p,_n))  {
    node=(wxwxMenuItemListNode*)NULL;
    _n++;
  } else {
    ...
    wrap_Erase::CallMember( ParamList* _p)
{
  ...
  wxwxMenuItemListNode* it;
  if (CheckNullVar(_p,_n))  {
    it=(wxwxMenuItemListNode*)NULL;
    _n++;
  } else {
...
{
  ADDPARAMCOMMENT_TYPE( _17735, "parameter named 'func'")
}
    ...
    wrap_Sort_1::CallMember( ParamList* _p)
{
  ...
  _17735 func;
  if (!get_val_param<_17735 >(func,_p,_n,true,true)) ClassReturnEmptyVar;
...
{
  ADDPARAMCOMMENT_TYPE( _5336, "parameter named 'func'")
}
    ...
    wrap_Sort_2::CallMember( ParamList* _p)
{
  ...
  _5336 func;
  if (!get_val_param<_5336 >(func,_p,_n,true,true)) ClassReturnEmptyVar;
