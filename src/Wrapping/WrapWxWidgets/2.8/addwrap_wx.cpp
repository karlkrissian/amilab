...
// Currently 180 objects (classes,structures,typedefs,...) are wrapped 
...
void wrap_wx_classes( Variables::ptr& context)
{
  ...
  ADD_WX_ENUMVAL(enum_139,wxPATH_MKDIR_FULL,1);
  ...
  ADD_WX_ENUMVAL(enum_137,wxNB_HITTEST_NOWHERE,1);
  ADD_WX_ENUMVAL(enum_137,wxNB_HITTEST_ONPAGE,8);
  ADD_WX_ENUMVAL(enum_137,wxNB_HITTEST_ONITEM,6);
  ADD_WX_ENUMVAL(enum_137,wxNB_HITTEST_ONICON,2);
  ADD_WX_ENUMVAL(enum_137,wxNB_HITTEST_ONLABEL,4);

  // Add enum to context, and add to default contexts
  context->AddVar<AMIObject>(obj_enum_137->GetName().c_str(),obj_enum_137,context);
  context->AddDefault(obj_enum_137->GetContext());

  // New enumeration enum_135
  AMIObject::ptr obj_enum_135(new AMIObject);
  obj_enum_135->SetName("enum_135");

  ADD_WX_ENUMVAL(enum_135,wxBK_HITTEST_ONLABEL,4);
  ADD_WX_ENUMVAL(enum_135,wxBK_HITTEST_ONPAGE,8);
  ADD_WX_ENUMVAL(enum_135,wxBK_HITTEST_ONICON,2);
  ADD_WX_ENUMVAL(enum_135,wxBK_HITTEST_ONITEM,6);
  ADD_WX_ENUMVAL(enum_135,wxBK_HITTEST_NOWHERE,1);

  // Add enum to context, and add to default contexts
  context->AddVar<AMIObject>(obj_enum_135->GetName().c_str(),obj_enum_135,context);
  context->AddDefault(obj_enum_135->GetContext());

  // New enumeration enum_138
  AMIObject::ptr obj_enum_138(new AMIObject);
  obj_enum_138->SetName("enum_138");

  ADD_WX_ENUMVAL(enum_138,wxPATH_GET_SEPARATOR,2);
  ADD_WX_ENUMVAL(enum_138,wxPATH_GET_VOLUME,1);
  ...
  ADD_WX_ENUMVAL(enum_130,wxLIST_AUTOSIZE_USEHEADER,-2);
  ADD_WX_ENUMVAL(enum_130,wxLIST_AUTOSIZE,-1);
  ...
  ADD_WX_ENUMVAL(enum_132,wxLIST_FIND_DOWN,1);
  ADD_WX_ENUMVAL(enum_132,wxLIST_FIND_RIGHT,3);
  ADD_WX_ENUMVAL(enum_132,wxLIST_FIND_UP,0);
  ADD_WX_ENUMVAL(enum_132,wxLIST_FIND_LEFT,2);
  ...
  ADD_WX_ENUMVAL(enum_131,wxLIST_RECT_BOUNDS,0);
  ADD_WX_ENUMVAL(enum_131,wxLIST_RECT_LABEL,2);
  ADD_WX_ENUMVAL(enum_131,wxLIST_RECT_ICON,1);
  ...
  ADD_WX_ENUMVAL(enum_145,wxPLATFORM_WINDOWS,1);
  ADD_WX_ENUMVAL(enum_145,wxPLATFORM_OS2,2);
  ADD_WX_ENUMVAL(enum_145,wxPLATFORM_CURRENT,-1);
  ADD_WX_ENUMVAL(enum_145,wxPLATFORM_MAC,3);
  ADD_WX_ENUMVAL(enum_145,wxPLATFORM_UNIX,0);
  ...
  ADD_WX_ENUMVAL(enum_143,wxHTML_FIND_EXACT,1);
  ADD_WX_ENUMVAL(enum_143,wxHTML_FIND_NEAREST_AFTER,4);
  ADD_WX_ENUMVAL(enum_143,wxHTML_FIND_NEAREST_BEFORE,2);
  ...
  ADD_WX_ENUMVAL(enum_140,wxCONFIG_USE_GLOBAL_FILE,2);
  ADD_WX_ENUMVAL(enum_140,wxCONFIG_USE_RELATIVE_PATH,4);
  ADD_WX_ENUMVAL(enum_140,wxCONFIG_USE_LOCAL_FILE,1);
  ADD_WX_ENUMVAL(enum_140,wxCONFIG_USE_NO_ESCAPE_CHARACTERS,8);
  ADD_WX_ENUMVAL(enum_140,wxCONFIG_USE_SUBDIR,16);
  ...
  ADD_WX_ENUMVAL(enum_142,wxFS_SEEKABLE,4);
  ADD_WX_ENUMVAL(enum_142,wxFS_READ,1);
  ...
  ADD_WX_ENUMVAL(enum_144,wxCONVERT_SUBSTITUTE,1);
  ADD_WX_ENUMVAL(enum_144,wxCONVERT_STRICT,0);
  ...
  ADD_WX_ENUMVAL(enum_128,wxLIST_NEXT_ABOVE,0);
  ADD_WX_ENUMVAL(enum_128,wxLIST_NEXT_BELOW,2);
  ADD_WX_ENUMVAL(enum_128,wxLIST_NEXT_ALL,1);
  ADD_WX_ENUMVAL(enum_128,wxLIST_NEXT_LEFT,3);
  ADD_WX_ENUMVAL(enum_128,wxLIST_NEXT_RIGHT,4);
  ...
  ADD_WX_ENUMVAL(enum_129,wxLIST_ALIGN_LEFT,1);
  ADD_WX_ENUMVAL(enum_129,wxLIST_ALIGN_SNAP_TO_GRID,3);
  ADD_WX_ENUMVAL(enum_129,wxLIST_ALIGN_TOP,2);
  ADD_WX_ENUMVAL(enum_129,wxLIST_ALIGN_DEFAULT,0);
