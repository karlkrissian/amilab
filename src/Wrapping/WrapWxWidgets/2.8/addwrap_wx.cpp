...
// Currently 182 objects (classes,structures,typedefs,...) are wrapped 
...
void wrap_wx_classes( Variables::ptr& context)
{
  ...
  ADD_WX_ENUMVAL(enum_124,wxTB_DOCKABLE,64);
  ADD_WX_ENUMVAL(enum_124,wxTB_3DBUTTONS,16);
  ADD_WX_ENUMVAL(enum_124,wxTB_FLAT,32);
  ADD_WX_ENUMVAL(enum_124,wxTB_TEXT,256);
  ADD_WX_ENUMVAL(enum_124,wxTB_RIGHT,16384);
  ADD_WX_ENUMVAL(enum_124,wxTB_VERTICAL,8);
  ADD_WX_ENUMVAL(enum_124,wxTB_HORIZONTAL,4);
  ADD_WX_ENUMVAL(enum_124,wxTB_BOTTOM,8192);
  ADD_WX_ENUMVAL(enum_124,wxTB_HORZ_TEXT,2304);
  ADD_WX_ENUMVAL(enum_124,wxTB_TOP,4);
  ADD_WX_ENUMVAL(enum_124,wxTB_NODIVIDER,512);
  ADD_WX_ENUMVAL(enum_124,wxTB_LEFT,8);
  ADD_WX_ENUMVAL(enum_124,wxTB_NOALIGN,1024);
  ADD_WX_ENUMVAL(enum_124,wxTB_NOICONS,128);
  ADD_WX_ENUMVAL(enum_124,wxTB_NO_TOOLTIPS,4096);
  ADD_WX_ENUMVAL(enum_124,wxTB_HORZ_LAYOUT,2048);
  ...
  ADD_WX_ENUMVAL(enum_143,wxFS_SEEKABLE,4);
  ADD_WX_ENUMVAL(enum_143,wxFS_READ,1);
  ...
  ADD_WX_ENUMVAL(enum_146,wxPLATFORM_WINDOWS,1);
  ADD_WX_ENUMVAL(enum_146,wxPLATFORM_OS2,2);
  ADD_WX_ENUMVAL(enum_146,wxPLATFORM_CURRENT,-1);
  ADD_WX_ENUMVAL(enum_146,wxPLATFORM_MAC,3);
  ADD_WX_ENUMVAL(enum_146,wxPLATFORM_UNIX,0);
  ...
  ADD_WX_ENUMVAL(enum_116,wxBMP_8BPP_PALETTE,11);
  ADD_WX_ENUMVAL(enum_116,wxBMP_1BPP_BW,2);
  ADD_WX_ENUMVAL(enum_116,wxBMP_1BPP,1);
  ADD_WX_ENUMVAL(enum_116,wxBMP_8BPP_GREY,9);
  ADD_WX_ENUMVAL(enum_116,wxBMP_24BPP,24);
  ADD_WX_ENUMVAL(enum_116,wxBMP_4BPP,4);
  ADD_WX_ENUMVAL(enum_116,wxBMP_8BPP_GRAY,9);
  ADD_WX_ENUMVAL(enum_116,wxBMP_8BPP_RED,10);
  ADD_WX_ENUMVAL(enum_116,wxBMP_8BPP,8);
