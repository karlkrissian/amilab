...
#include "wrap_wxObject.h"//#include "wrap_wxClientDataContainer.h"
    ...
    , public   WrapClass_wxObject//, public  WrapClass_wxClientDataContainer
{
  ...
  public:
    ...
    ~WrapClass_wxSizer()
    {
      std::cout << "~WrapClass_wxSizer()" << std::endl;
    ...
    // Operators:
    ADD_CLASS_METHOD(__assign__,            "wxSizer & wxSizer::=(wxSizer const & param0) (http://docs.wxwidgets.org/stable/wx_wxsizer.html#__assign__)")
