...
#include "stdlib.h"
#ifndef wxObjectList_declared
  #define wxObjectList_declared
...
/*
  ...
  */
void WrapClasswxObjectList_AddStaticMethods( Variables::ptr& context)
{
  // Create a new context (or namespace) for the class
  AMIObject::ptr amiobject(new AMIObject);
  amiobject->SetName("wxObjectList");
    WrapClass_wxObjectList::AddVar_wxObjectList_1(amiobject->GetContext());
  WrapClass_wxObjectList::AddVar_wxObjectList(amiobject->GetContext());
  WrapClass_wxObjectList::AddVar_wxObjectList_2(amiobject->GetContext());
  WrapClass_wxObjectList::AddVar_wxObjectList_3(amiobject->GetContext());
  WrapClass_wxObjectList::AddVar_wxObjectList_4(amiobject->GetContext());
  /* Types are missing
  WrapClass_wxObjectList::AddVar_wxObjectList_5(amiobject->GetContext());
  */
    ...
    wrap_wxObjectList_2::CallMember( ParamList* _p)
{
  ...
  if (!get_val_smtptr_param<wxObjectList >(list_smtptr,_p,_n,true,true,true)) ClassReturnEmptyVar;
    ...
    wrap_wxObjectList_3::CallMember( ParamList* _p)
{
  ...
  wxObject* local_elements = NULL;
  wxObject** elements;
  if (CheckNullVar(_p,_n))  {
    elements=(wxObject**)NULL;
    _n++;
  } else {
    boost::shared_ptr<wxObject > elements_smtptr;
    if (!get_val_smtptr_param<wxObject >(elements_smtptr,_p,_n,true,false,true)) ClassReturnEmptyVar;
    local_elements = elements_smtptr.get();
    ...
    wrap_wxObjectList_4::CallMember( ParamList* _p)
{
  ...
  if (!get_val_smtptr_param<wxObject >(v_smtptr,_p,_n,false,false,true)) ClassReturnEmptyVar;
    ...
    wrap_Append_1::CallMember( ParamList* _p)
{
  ...
  if (CheckNullVar(_p,_n))  {
    ...
    if (!get_val_smtptr_param<wxObject >(object_smtptr,_p,_n,true,false,true)) ClassReturnEmptyVar;
    ...
    wrap_Insert_3::CallMember( ParamList* _p)
{
  ...
  wxObjectListNode* prev;
  if (CheckNullVar(_p,_n))  {
    prev=(wxObjectListNode*)NULL;
    _n++;
  } else {
    boost::shared_ptr<wxObjectListNode > prev_smtptr;
    if (!get_val_smtptr_param<wxObjectListNode >(prev_smtptr,_p,_n,true,false,true)) ClassReturnEmptyVar;
    prev = prev_smtptr.get();
  }
    ...
    wrap_DetachNode::CallMember( ParamList* _p)
{
  ...
  wxObjectListNode* node;
  if (CheckNullVar(_p,_n))  {
    node=(wxObjectListNode*)NULL;
    _n++;
  } else {
    boost::shared_ptr<wxObjectListNode > node_smtptr;
    if (!get_val_smtptr_param<wxObjectListNode >(node_smtptr,_p,_n,true,false,false)) ClassHelpAndReturn;
    node = node_smtptr.get();
  }
    ...
    wrap_Erase::CallMember( ParamList* _p)
{
  ...
  wxObjectListNode* it;
  if (CheckNullVar(_p,_n))  {
    it=(wxObjectListNode*)NULL;
    _n++;
  } else {
    boost::shared_ptr<wxObjectListNode > it_smtptr;
    if (!get_val_smtptr_param<wxObjectListNode >(it_smtptr,_p,_n,true,false,false)) ClassHelpAndReturn;
    it = it_smtptr.get();
  }
...
{
  ADDPARAMCOMMENT_TYPE( _17099, "parameter named 'func'")
}
    ...
    wrap_Sort_2::CallMember( ParamList* _p)
{
  ...
  _17099 func;
  if (!get_val_param<_17099 >(func,_p,_n,true,true)) ClassReturnEmptyVar;
    ...
    wrap_resize::CallMember( ParamList* _p)
{
  ...
  if (CheckNullVar(_p,_n))  {
    ...
    boost::shared_ptr<wxObject > v_smtptr;
    if (!get_val_smtptr_param<wxObject >(v_smtptr,_p,_n,false,false,false)) ClassHelpAndReturn;
    v = v_smtptr.get();
  }
    ...
    wrap_splice_1::CallMember( ParamList* _p)
{
  ...
  if (!get_val_smtptr_param<wxObjectList >(l_smtptr,_p,_n,true,false,true)) ClassReturnEmptyVar;
    ...
    wrap_remove::CallMember( ParamList* _p)
{
  ...
  boost::shared_ptr<wxObject > v_smtptr;
  if (!get_val_smtptr_param<wxObject >(v_smtptr,_p,_n,true,false,false)) ClassHelpAndReturn;
    ...
    wrap___assign__::CallMember( ParamList* _p)
{
  ...
  boost::shared_ptr<wxObjectList > list_smtptr;
  if (!get_val_smtptr_param<wxObjectList >(list_smtptr,_p,_n,true,false,false)) ClassHelpAndReturn;
  wxObjectList const & list = *list_smtptr;
