...
*/
/* The following types are missing: wxToolBarToolBase
    ADD_CLASS_METHOD(AddControl,"wxToolBarToolBase * wxToolBarBase::AddControl(wxControl * control, wxString const & label = wxEmptyString)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#addcontrol)")
*/
/* The following types are missing: wxToolBarToolBase
    ADD_CLASS_METHOD(InsertControl,"wxToolBarToolBase * wxToolBarBase::InsertControl(size_t pos, wxControl * control, wxString const & label = wxEmptyString)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#insertcontrol)")
*/
...
*/
/* The following types are missing: wxToolBarToolBase
    ADD_CLASS_METHOD(AddStretchableSpace,"wxToolBarToolBase * wxToolBarBase::AddStretchableSpace()  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#addstretchablespace)")
*/
/* The following types are missing: wxToolBarToolBase
    ADD_CLASS_METHOD(InsertStretchableSpace,"wxToolBarToolBase * wxToolBarBase::InsertStretchableSpace(size_t pos)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#insertstretchablespace)")
*/
/* The following types are missing: wxToolBarToolBase
...
*/
    ...
    ADD_CLASS_METHOD(SetToolNormalBitmap,"void wxToolBarBase::SetToolNormalBitmap(int param0, wxBitmap const & param1)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#settoolnormalbitmap)")
    ADD_CLASS_METHOD(SetToolDisabledBitmap,"void wxToolBarBase::SetToolDisabledBitmap(int param0, wxBitmap const & param1)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#settooldisabledbitmap)")
...
/* The following types are missing: wxToolBarToolBase
    ADD_CLASS_METHOD(GetToolByPos,"wxToolBarToolBase const * wxToolBarBase::GetToolByPos(int pos)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#gettoolbypos)")
*/
/* The following types are missing: wxToolBarToolBase
...
/* The following types are missing: wxMenu
    ADD_CLASS_METHOD(SetDropdownMenu,"bool wxToolBarBase::SetDropdownMenu(int toolid, wxMenu * menu)  (http://docs.wxwidgets.org/stable/wx_wxtoolbarbase.html#setdropdownmenu)")
*/
