    ...
    , public   WrapClass_wxToolBarBase
{
  ...
  public:
    ...
    ADD_CLASS_METHOD(Create,"bool wxToolBar::Create(wxWindow * parent, wxWindowID id, wxPoint const & pos = wxDefaultPosition, wxSize const & size = wxDefaultSize, long int style = wxTB_HORIZONTAL, wxString const & name = wxToolBarNameStr)  (http://docs.wxwidgets.org/stable/wx_wxtoolbar.html#create)")
...
*/
    ...
    ADD_CLASS_METHOD(Realize,"bool wxToolBar::Realize()  (http://docs.wxwidgets.org/stable/wx_wxtoolbar.html#realize)")
