...
BasicVariable::ptr AMILabType<wxToolBarBase>::CreateVar( wxToolBarBase* val)
{ 
  boost::shared_ptr<wxToolBarBase> obj_ptr(val,wxwindow_nodeleter<wxToolBarBase>());
...
*/
/* The following types are missing: wxToolBarToolBase, wxToolBarToolBase
...
*/
/* The following types are missing: wxToolBarToolBase
      AddVar_AddStretchableSpace( this_ptr);
*/
/* The following types are missing: wxToolBarToolBase
      AddVar_InsertStretchableSpace( this_ptr);
*/
/* The following types are missing: wxToolBarToolBase
...
/* The following types are missing: wxMenu
      AddVar_SetDropdownMenu( this_ptr);
*/
...
//---------------------------------------------------
//  Wrapping of wxToolBarToolBase * wxToolBarBase::AddControl(wxControl * control, wxString const & label = wxEmptyString)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    ...
    wrap_AddControl::CallMember( ParamList* _p)
{
  ...
  wxToolBarToolBase * res =   this->_objectptr->GetObj()->AddControl(control, label);
  return AMILabType<wxToolBarToolBase >::CreateVar(res);
}
*/
/* The following types are missing: wxToolBarToolBase
...
//---------------------------------------------------
//  Wrapping of wxToolBarToolBase * wxToolBarBase::InsertControl(size_t pos, wxControl * control, wxString const & label = wxEmptyString)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    ...
    wrap_InsertControl::CallMember( ParamList* _p)
{
  ...
  wxToolBarToolBase * res =   this->_objectptr->GetObj()->InsertControl(pos, control, label);
  return AMILabType<wxToolBarToolBase >::CreateVar(res);
}
*/
...
//---------------------------------------------------
//  Wrapping of wxToolBarToolBase * wxToolBarBase::AddStretchableSpace()
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    wrap_AddStretchableSpace::SetParametersComments()
{
  return_comments="returning a variable of type wxToolBarToolBase";
}
...
//---------------------------------------------------
BasicVariable::ptr WrapClass_wxToolBarBase::
    wrap_AddStretchableSpace::CallMember( ParamList* _p)
{
  if (_p)  if (_p->GetNumParam()>0) ClassHelpAndReturn;

  wxToolBarToolBase * res =   this->_objectptr->GetObj()->AddStretchableSpace();
  return AMILabType<wxToolBarToolBase >::CreateVar(res);
}
*/
/* The following types are missing: wxToolBarToolBase
...
//---------------------------------------------------
//  Wrapping of wxToolBarToolBase * wxToolBarBase::InsertStretchableSpace(size_t pos)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    wrap_InsertStretchableSpace::SetParametersComments()
{
  ADDPARAMCOMMENT_TYPE( long, "parameter named 'pos'")
  return_comments="returning a variable of type wxToolBarToolBase";
}
...
//---------------------------------------------------
BasicVariable::ptr WrapClass_wxToolBarBase::
    wrap_InsertStretchableSpace::CallMember( ParamList* _p)
{
  if (!_p) ClassHelpAndReturn;
  if (_p->GetNumParam()>1) ClassHelpAndReturn;
  int _n=0;
  ...
  wxToolBarToolBase * res =   this->_objectptr->GetObj()->InsertStretchableSpace(pos);
  return AMILabType<wxToolBarToolBase >::CreateVar(res);
}
*/
/* The following types are missing: wxToolBarToolBase
...
//---------------------------------------------------
//  Wrapping of void wxToolBarBase::SetToolNormalBitmap(int param0, wxBitmap const & param1)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    wrap_SetToolNormalBitmap::SetParametersComments()
{
  ADDPARAMCOMMENT_TYPE( int, "parameter named 'param0'")
  ADDPARAMCOMMENT_TYPE( wxBitmap, "parameter named 'param1'")
}
    ...
    wrap_SetToolNormalBitmap::CallMember( ParamList* _p)
{
  ...
  boost::shared_ptr<wxBitmap > param1_smtptr;
  if (!get_val_smtptr_param<wxBitmap >(param1_smtptr,_p,_n)) ClassHelpAndReturn;
  wxBitmap const & param1 = *param1_smtptr;

  this->_objectptr->GetObj()->SetToolNormalBitmap(param0, param1);
  return BasicVariable::ptr();
}

//---------------------------------------------------
//  Wrapping of void wxToolBarBase::SetToolDisabledBitmap(int param0, wxBitmap const & param1)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    ...
    wrap_SetToolDisabledBitmap::CallMember( ParamList* _p)
{
  ...
  this->_objectptr->GetObj()->SetToolDisabledBitmap(param0, param1);
  return BasicVariable::ptr();
}
...
//---------------------------------------------------
//  Wrapping of wxToolBarToolBase const * wxToolBarBase::GetToolByPos(int pos)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    wrap_GetToolByPos::SetParametersComments()
{
...
//---------------------------------------------------
BasicVariable::ptr WrapClass_wxToolBarBase::
    wrap_GetToolByPos::CallMember( ParamList* _p)
{
  if (!_p) ClassHelpAndReturn;
  if (_p->GetNumParam()>1) ClassHelpAndReturn;
  int _n=0;
  ...
  wxToolBarToolBase const * res =   this->_objectptr->GetObj()->GetToolByPos(pos);
  return AMILabType<wxToolBarToolBase >::CreateVar(res);
}
*/
/* The following types are missing: wxToolBarToolBase
    ...
    wrap_AddTool_4::CallMember( ParamList* _p)
{
  ...
  // Setting default value if no value is returned
  wxString const & shortHelpString = ( shortHelpString_smtptr.get() ? (*shortHelpString_smtptr) : (wxEmptyString) );
  ...
  // Setting default value if no value is returned
  wxString const & longHelpString = ( longHelpString_smtptr.get() ? (*longHelpString_smtptr) : (wxEmptyString) );
...
{
  ADDPARAMCOMMENT_TYPE( int, "parameter named 'toolid'")
  ADDPARAMCOMMENT_TYPE( int, "parameter named 'toggleDown'")
  return_comments="returning a variable of type int";
}
...
//---------------------------------------------------
//  Wrapping of bool wxToolBarBase::SetDropdownMenu(int toolid, wxMenu * menu)
//---------------------------------------------------
void WrapClass_wxToolBarBase::
    wrap_SetDropdownMenu::SetParametersComments()
{
  ADDPARAMCOMMENT_TYPE( int, "parameter named 'toolid'")
...
//---------------------------------------------------
BasicVariable::ptr WrapClass_wxToolBarBase::
    wrap_SetDropdownMenu::CallMember( ParamList* _p)
{
  if (!_p) ClassHelpAndReturn;
  if (_p->GetNumParam()>2) ClassHelpAndReturn;
  int _n=0;
  ...
  bool res =   this->_objectptr->GetObj()->SetDropdownMenu(toolid, menu);
  int res_int = ((res==true)?1:0);
  return AMILabType<int >::CreateVar(res_int);
}
*/
