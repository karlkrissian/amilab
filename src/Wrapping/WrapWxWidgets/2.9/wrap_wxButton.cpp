...
BasicVariable::ptr AMILabType<wxButton>::CreateVar( wxButton* val)
{ 
  boost::shared_ptr<wxButton> obj_ptr(val,wxwindow_nodeleter<wxButton>());
...
*/
      ...
      AddVar_GTKMouseEnters( this_ptr);
      AddVar_GTKMouseLeaves( this_ptr);
      AddVar_GTKPressed( this_ptr);
      AddVar_GTKReleased( this_ptr);
...
//---------------------------------------------------
//  Wrapping of wxWindow * wxButton::SetDefault()
//---------------------------------------------------
void WrapClass_wxButton::
...
//---------------------------------------------------
//  Wrapping of bool wxButton::Enable(bool enable = true)
//---------------------------------------------------
void WrapClass_wxButton::
...
//---------------------------------------------------
//  Wrapping of void wxButton::GTKMouseEnters()
//---------------------------------------------------
void WrapClass_wxButton::
    wrap_GTKMouseEnters::SetParametersComments()
{
}

//---------------------------------------------------
BasicVariable::ptr WrapClass_wxButton::
    wrap_GTKMouseEnters::CallMember( ParamList* _p)
{
  if (_p)  if (_p->GetNumParam()>0) ClassHelpAndReturn;

  this->_objectptr->GetObj()->GTKMouseEnters();
  return BasicVariable::ptr();
}

//---------------------------------------------------
//  Wrapping of void wxButton::GTKMouseLeaves()
//---------------------------------------------------
void WrapClass_wxButton::
    wrap_GTKMouseLeaves::SetParametersComments()
{
}

//---------------------------------------------------
BasicVariable::ptr WrapClass_wxButton::
    wrap_GTKMouseLeaves::CallMember( ParamList* _p)
{
  if (_p)  if (_p->GetNumParam()>0) ClassHelpAndReturn;

  this->_objectptr->GetObj()->GTKMouseLeaves();
  return BasicVariable::ptr();
}

//---------------------------------------------------
//  Wrapping of void wxButton::GTKPressed()
//---------------------------------------------------
void WrapClass_wxButton::
    wrap_GTKPressed::SetParametersComments()
{
}

//---------------------------------------------------
BasicVariable::ptr WrapClass_wxButton::
    wrap_GTKPressed::CallMember( ParamList* _p)
{
  if (_p)  if (_p->GetNumParam()>0) ClassHelpAndReturn;

  this->_objectptr->GetObj()->GTKPressed();
  return BasicVariable::ptr();
}

//---------------------------------------------------
//  Wrapping of void wxButton::GTKReleased()
//---------------------------------------------------
void WrapClass_wxButton::
    wrap_GTKReleased::SetParametersComments()
{
}

//---------------------------------------------------
BasicVariable::ptr WrapClass_wxButton::
    wrap_GTKReleased::CallMember( ParamList* _p)
{
  if (_p)  if (_p->GetNumParam()>0) ClassHelpAndReturn;

  this->_objectptr->GetObj()->GTKReleased();
  return BasicVariable::ptr();
}
