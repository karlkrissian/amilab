    ...
    //, public  WrapClass_vtkLinearTransform
{
  ...
  public:
    ...
    ADD_CLASS_STATICMETHOD(GetOrientation_4,"void vtkTransform::GetOrientation(double * orient, vtkMatrix4x4 * matrix) (http://docs.wxwidgets.org/stable/wx_vtktransform.html#getorientation).");
    */
