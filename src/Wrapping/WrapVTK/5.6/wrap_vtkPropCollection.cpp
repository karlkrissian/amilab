...
BasicVariable::ptr AMILabType<vtkPropCollection>::CreateVar( vtkPropCollection* val)
{ 
  boost::shared_ptr<vtkPropCollection> obj_ptr(val,wxwindow_nodeleter<vtkPropCollection>());
