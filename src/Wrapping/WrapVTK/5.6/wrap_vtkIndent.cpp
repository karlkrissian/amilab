...
void WrapClassvtkIndent_AddStaticMethods( Variables::ptr& context)
{
  ...
  amiobject->SetName("vtkIndent");
    WrapClass_vtkIndent::AddVar_vtkIndent_1(amiobject->GetContext());
  WrapClass_vtkIndent::AddVar_vtkIndent(amiobject->GetContext());
  WrapClass_vtkIndent::AddVar_vtkIndent_2(amiobject->GetContext());
    ...
    wrap_static_New::CallMember( ParamList* _p)
{
  ...
  BasicVariable::ptr res_var = AMILabType<vtkIndent >::CreateVar(res,true);
  return res_var;
}
