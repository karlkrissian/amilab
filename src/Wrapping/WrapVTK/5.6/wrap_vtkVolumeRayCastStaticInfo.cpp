...
void WrapClass_vtkVolumeRayCastStaticInfo::AddMethods(WrapClass<vtkVolumeRayCastStaticInfo>::ptr this_ptr )
{
  ...
  // Add public fields
      ...
      boost::shared_ptr< > var_WorldToVoxelsMatrix_ptr(&GetObj()->WorldToVoxelsMatrix, smartpointer_nodeleter< >());
      if (var_WorldToVoxelsMatrix_ptr.get()) {
        BasicVariable::ptr var_WorldToVoxelsMatrix = AMILabType< >::CreateVarFromSmtPtr(var_WorldToVoxelsMatrix_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_VoxelsToWorldMatrix_ptr(&GetObj()->VoxelsToWorldMatrix, smartpointer_nodeleter< >());
      if (var_VoxelsToWorldMatrix_ptr.get()) {
        BasicVariable::ptr var_VoxelsToWorldMatrix = AMILabType< >::CreateVarFromSmtPtr(var_VoxelsToWorldMatrix_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_ViewToVoxelsMatrix_ptr(&GetObj()->ViewToVoxelsMatrix, smartpointer_nodeleter< >());
      if (var_ViewToVoxelsMatrix_ptr.get()) {
        BasicVariable::ptr var_ViewToVoxelsMatrix = AMILabType< >::CreateVarFromSmtPtr(var_ViewToVoxelsMatrix_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_DataIncrement_ptr(&GetObj()->DataIncrement, smartpointer_nodeleter< >());
      if (var_DataIncrement_ptr.get()) {
        BasicVariable::ptr var_DataIncrement = AMILabType< >::CreateVarFromSmtPtr(var_DataIncrement_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_DataSize_ptr(&GetObj()->DataSize, smartpointer_nodeleter< >());
      if (var_DataSize_ptr.get()) {
        BasicVariable::ptr var_DataSize = AMILabType< >::CreateVarFromSmtPtr(var_DataSize_ptr);
        if (var_DataSize.get()) {
      ...
      */
      ...
      boost::shared_ptr< > var_DataSpacing_ptr(&GetObj()->DataSpacing, smartpointer_nodeleter< >());
      if (var_DataSpacing_ptr.get()) {
        BasicVariable::ptr var_DataSpacing = AMILabType< >::CreateVarFromSmtPtr(var_DataSpacing_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_DataOrigin_ptr(&GetObj()->DataOrigin, smartpointer_nodeleter< >());
      if (var_DataOrigin_ptr.get()) {
        BasicVariable::ptr var_DataOrigin = AMILabType< >::CreateVarFromSmtPtr(var_DataOrigin_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_ImageInUseSize_ptr(&GetObj()->ImageInUseSize, smartpointer_nodeleter< >());
      if (var_ImageInUseSize_ptr.get()) {
        BasicVariable::ptr var_ImageInUseSize = AMILabType< >::CreateVarFromSmtPtr(var_ImageInUseSize_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_ImageMemorySize_ptr(&GetObj()->ImageMemorySize, smartpointer_nodeleter< >());
      if (var_ImageMemorySize_ptr.get()) {
        BasicVariable::ptr var_ImageMemorySize = AMILabType< >::CreateVarFromSmtPtr(var_ImageMemorySize_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_ImageViewportSize_ptr(&GetObj()->ImageViewportSize, smartpointer_nodeleter< >());
      if (var_ImageViewportSize_ptr.get()) {
        BasicVariable::ptr var_ImageViewportSize = AMILabType< >::CreateVarFromSmtPtr(var_ImageViewportSize_ptr);
      ...
      */
      ...
      boost::shared_ptr< > var_ImageOrigin_ptr(&GetObj()->ImageOrigin, smartpointer_nodeleter< >());
      if (var_ImageOrigin_ptr.get()) {
        BasicVariable::ptr var_ImageOrigin = AMILabType< >::CreateVarFromSmtPtr(var_ImageOrigin_ptr);
...
/*
  ...
  */
void WrapClass_vtkVolumeRayCastStaticInfo::AddStaticMethods( Variables::ptr& context)
{
