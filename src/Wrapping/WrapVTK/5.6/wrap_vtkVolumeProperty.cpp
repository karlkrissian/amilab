...
BasicVariable::ptr AMILabType<vtkVolumeProperty>::CreateVar( vtkVolumeProperty* val)
{ 
  boost::shared_ptr<vtkVolumeProperty> obj_ptr(val,wxwindow_nodeleter<vtkVolumeProperty>());
    ...
    wrap_SetScalarOpacityUnitDistance_1::CallMember( ParamList* _p)
{
  ...
  double distance;
  if (!get_val_param<double >(distance,_p,_n)) ClassReturnEmptyVar;
    ...
    wrap_SetAmbient_1::CallMember( ParamList* _p)
{
  ...
  double value;
  if (!get_val_param<double >(value,_p,_n)) ClassReturnEmptyVar;
