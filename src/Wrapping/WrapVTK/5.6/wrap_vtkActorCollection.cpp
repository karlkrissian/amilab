...
BasicVariable::ptr AMILabType<vtkActorCollection>::CreateVar( vtkActorCollection* val)
{ 
  boost::shared_ptr<vtkActorCollection> obj_ptr(val,wxwindow_nodeleter<vtkActorCollection>());
