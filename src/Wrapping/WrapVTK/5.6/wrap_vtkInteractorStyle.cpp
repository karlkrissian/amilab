...
void WrapClassvtkInteractorStyle_AddStaticMethods( Variables::ptr& context)
{
  ...
  amiobject->SetName("vtkInteractorStyle");
  
  // Static methods 
  WrapClass_vtkInteractorStyle::AddVar_New(amiobject->GetContext());
  WrapClass_vtkInteractorStyle::AddVar_IsTypeOf(amiobject->GetContext());
