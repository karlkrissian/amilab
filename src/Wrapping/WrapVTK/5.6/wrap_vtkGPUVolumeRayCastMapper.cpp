...
void WrapClassvtkGPUVolumeRayCastMapper_AddStaticMethods( Variables::ptr& context)
{
  ...
  amiobject->SetName("vtkGPUVolumeRayCastMapper");
  
  // Static methods 
  WrapClass_vtkGPUVolumeRayCastMapper::AddVar_New(amiobject->GetContext());
  WrapClass_vtkGPUVolumeRayCastMapper::AddVar_IsTypeOf(amiobject->GetContext());
  WrapClass_vtkGPUVolumeRayCastMapper::AddVar_SafeDownCast(amiobject->GetContext());
