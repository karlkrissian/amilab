...
{
  /*
      // Add members from vtkDataArrayTemplate<int>
      WrapClass_vtkDataArrayTemplate_int_::ptr parent_vtkDataArrayTemplate_int_(        boost::dynamic_pointer_cast<WrapClass_vtkDataArrayTemplate_int_ >(this_ptr));
      parent_vtkDataArrayTemplate_int_->AddMethods(parent_vtkDataArrayTemplate_int_);
      */
    ...
    wrap_static_New::CallMember( ParamList* _p)
{
  ...
  BasicVariable::ptr res_var = WrapClass_vtkIntArray::CreateVar(res);
  return res_var;
}
