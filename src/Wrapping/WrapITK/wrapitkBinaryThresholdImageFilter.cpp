...
InrImage* itkBinaryThresholdImageFilter2D(ParamList* p)
{
  ...
  return NULL;
#endif // _WITHOUT_ITK_	
} //itkBinaryThresholdImageFilter2D


InrImage* itkBinaryThresholdImageFilter3D(ParamList* p)
{
  ...
  return NULL;
#endif // _WITHOUT_ITK_	
} //itkBinaryThresholdImageFilter3D