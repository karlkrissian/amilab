...
template<> LanguageBase_EXPORT BasicVariable::ptr Variable<InrImage>::NewCopy() const;

// Arithmetic operators

/// +a
template<> LanguageBase_EXPORT BasicVariable::ptr Variable<InrImage>::operator +();
...
/// postfix ++ operator a++
template<> LanguageBase_EXPORT BasicVariable::ptr Variable<InrImage>::operator ++(int);
*/
 ...
 * @return 
 */
template<> LanguageBase_EXPORT BasicVariable::ptr Variable<InrImage>::BasicCast(const int& type);
...
/*
/// (cond?a:b)
template<> LanguageBase_EXPORT BasicVariable::ptr Variable<InrImage>::TernaryCondition(const BasicVariable::ptr& v1, const BasicVariable::ptr&v2);
*/
 ...
 * @return 
 */
template<> LanguageBase_EXPORT BasicVariable::ptr Variable<InrImage>::left_assign(const BasicVariable::ptr& b);
