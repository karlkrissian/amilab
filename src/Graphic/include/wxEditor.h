...
//----------------------------------------------------------------------------
//! wxEditor
class wxEditor: public wxStyledTextCtrl {
    friend class EditProperties;
    friend class EditPrint;

public:
    //! constructor
    wxEditor (wxWindow *parent, wxWindowID id = wxID_ANY,
...
public:
    ...
    //! constructor
    EditProperties (wxEditor *edit, long style = 0);
...
public:
    ...
    //! constructor
    EditPrint (wxEditor *edit, const wxChar *title = _T(""));
...
public:
   ...
   */
  FindAndReplace (wxEditor* openEditor);
  //Destructor
  ~FindAndReplace ();
