...
inrimage *readZInrimage(const char * name /* Image name*/);
/* Read an image in given file and return an inrimage descriptor or NULL<br>
   if the image type is not recognized */

inrimage *readNonInterlacedZInrimage(const char * name /* Image name*/);
/* Read an image in given file and return an inrimage descriptor or NULL<br>
...
int writeZInrimage(const inrimage *inr /* Inrimage descriptor */,
...
INRIMAGE_HEADER *readZInrimageHeader(const char *name /* Image name */);
/* Read the header from an inrimage file. <br>
   Inrimage <tt>data</tt> and <tt>array</tt> pointers are set to NULL. */



inrimage *createInrimage(int ncols /* Number of columns (X dimension)*/,
			 int nrows /* Number of rows (Y dimension)*/,
			 int nplanes /* Number of planes (Z dimension)*/,
...
inrimage *createNonInterlacedInrimage(
			 int ncols     /* Number of columns (X dimension)*/,
			 int nrows     /* Number of rows (Y dimension)*/,
			 int nplanes   /* Number of planes (Z dimension)*/,
			 int vdim      /* Vector dimension */,
...
inrimage *initInrimage(int ncols /* Number of columns (X dimension)*/,
		       int nrows /* Number of rows (Y dimension)*/,
		       int nplanes /* Number of planes (Z dimension)*/,
		       int vdim /* Vector dimension */,
		       WORDTYPE type /* Image voxel word type */);
...
void setInrimageData(inrimage *inr /* Inrimage descriptor */,
		     void *data    /* Data buffer */);
/* Changes the <tt>data</tt> field of an inrimage and set <tt>array</tt><br>
   pointers on new data. */

void setNonInterlacedInrimageData(inrimage *inr /* Inrimage descriptor */,
				  void *data    /* Data buffer */);
...
void freeInrimage(inrimage *inr /* Inrimage descriptor */);
