...
#line 141 "/home/karl/projects/Sourceforge/amilab/trunk/src/Language/improcess_bison.tab.hpp"
   ...
   enum yytokentype {
     ...
     T_SetShininess = 619,
     T_SetOpacity = 620,
     T_SetOpacityImage = 621,
     T_SetVisible = 622,
     T_SetColorMaterial = 623,
     T_penguin = 624,
     T_Statistics = 625,
     T_GetIntensities = 626,
     T_GetLinesLength = 627,
     T_GetLinesExtremities = 628,
     T_GetConnections = 629,
     T_SelectLines = 630,
     T_RemoveSelection = 631,
     T_mergepoints = 632,
     T_Triangulate = 633,
     T_Displace = 634,
     T_Normals = 635,
     ...
     T_Translate = 637,
     T_Scale = 638,
     T_SetPointsColors = 639,
     T_SetLineWidth = 640,
     T_AddPoint = 641,
     T_NewLine = 642,
     T_EndLine = 643,
     T_LineAddPointNumber = 644,
     T_GetTransform = 645,
     T_SetTransform = 646,
     T_Interpolate = 647,
     T_Matrix = 648,
     ...
     SETVECTOR = 656,
     T_lininterp = 657,
     T_SetCompareDisplacement = 658,
     T_DrawVector = 659,
     T_DisplayVectors = 660,
     T_SetVectParam = 661,
     T_SetVectColor = 662,
     T_SetVectStyle = 663,
     T_SetLineThickness = 664,
     T_SetZoom = 665,
     T_SetWindowSize = 666,
     T_SetColormap = 667,
     T_drawcircle = 668,
     ...
     T_ConvexHull = 746,
     T_itk = 747,
     T_CannyEdgeDetector = 748,
     T_CreateFlatMesh = 749,
     T_CreateVolume = 750,
     T_vtkCreateFlatMesh = 751,
     T_Altitude2Position = 752,
     T_GeoCoordinates = 753,
     T_ElevateMesh = 754,
     T_CreateVectors = 755,
     T_Set3DArrowParam = 756,
     T_CreateEllipsoids = 757,
     T_ComputeAltitudes = 758,
     T_Temp2Altitudes = 759,
     T_ReadFlow = 760,
     T_SetFluidNavFile = 761,
     T_DrawEarthCoord = 762,
     T_PaintCallback = 763,
     T_SaveStructuredGrid = 764,
     T_import_ami = 765,
     T_import_vtk = 766,
     T_import_itk = 767,
     T_import_wii = 768,
     T_import_filters = 769,
     T_import_sys = 770,
     T_amiOFCorr2D = 771,
     T_amiOFVar2D = 772
   };
...
/* Line 35 of lalr1.cc  */
#line 845 "/home/karl/projects/Sourceforge/amilab/trunk/src/Language/improcess_bison.tab.hpp"
