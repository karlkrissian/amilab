...
//                                ------------
{
  ...
  Pour(i,0,NB_IMAGES-1)
    Si _utilise_Image_sigma[i] Alors
      _InrImage_sigma[i] = new InrImage( WT_FLOAT, 
                                         (char*) _ImageNom[i],
                                         _InrImage_initiale);
    FinSi
  FinPour
